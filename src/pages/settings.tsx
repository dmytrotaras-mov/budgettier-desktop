            ...
            >
              <div style={{ padding: '12px 16px', borderBottom: '1px solid #F3F4F6' }} className="sm:p-[15px_20px]">
                <div className="flex items-center justify-between gap-2">
                  <h2 style={{ fontFamily: 'Inter', fontSize: '20px', fontWeight: 500, color: '#000' }} className="sm:text-2xl truncate">
                    Subscription
                  </h2>
                  <button
                    onClick={() => {
                      ...
                      if (window.umami) {
                        window.umami.track('upgrade_button_clicked', { location: 'settings_subscription' });
                      }
                    }}
                    style={{
                      height: '32px',
                      padding: '0 12px',
                      background: 'linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)',
                      color: '#fff',
                      border: 'none',
                      borderRadius: '20px',
                      fontFamily: 'Inter',
                    ...
                    className="hover:opacity-90 sm:h-[35px] sm:px-4 sm:text-xs"
                  >
                    Upgrade Plan
                  </button>
                </div>
              ...
              <div style={{ padding: '12px 16px' }} className="sm:p-[15px_20px]">
                <div
                  onClick={() => {
                    ...
                    // Track upgrade button click
                    if (window.umami) {
                      window.umami.track('upgrade_button_clicked', { location: 'settings_free_plan' });
                    }
                  }}
                  className="hover:bg-gray-100 transition-colors cursor-pointer sm:rounded-[20px] sm:p-[15px_20px]"
                  style={{ backgroundColor: '#F3F4F6', borderRadius: '16px', padding: '12px 16px' }}
                >
                  <div className="flex items-center gap-2">
                    <p style={{ fontFamily: 'Inter', fontSize: '18px', fontWeight: 700, color: '#000' }} className="sm:text-xl">
                      Free Plan
                    </p>
                    <span
                      style={{
  ...
  return (
    <div className="flex-1 pb-20 md:pb-0" style={{ backgroundColor: '#F3F4F6' }}>
      ...
      <Dialog open={isUpgradeDialogOpen} onOpenChange={setIsUpgradeDialogOpen}>
        <DialogContent className="max-w-4xl" style={{ backgroundColor: '#F3F4F6', padding: '32px', borderRadius: '20px' }}>
          <DialogHeader>
            <DialogTitle style={{ fontFamily: 'Inter', fontSize: '28px', fontWeight: 600, color: '#000', textAlign: 'center', marginBottom: '8px' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-6">
            {/* Free Tier */}
            <div className="bg-white" style={{ borderRadius: '20px', padding: '24px', position: 'relative' }}>
              <div className="flex items-center justify-between mb-4">
                <h3 style={{ fontFamily: 'Inter', fontSize: '24px', fontWeight: 600, color: '#000' }}>Free</h3>
                <span
                  style={{
                    fontFamily: 'Inter',
                    fontSize: '10px',
              ...
              <div className="mb-6">
                <div style={{ fontFamily: 'Inter', fontSize: '40px', fontWeight: 700, color: '#000' }}>$0</div>
                <div style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#6B7280' }}>Forever free</div>
              </div>

              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#86EFAC', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#000', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Unlimited transactions & wallets</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#86EFAC', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#000', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Budget planning & tracking</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#86EFAC', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#000', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>A variety of charts</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#86EFAC', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#000', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Custom categories & tags</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#86EFAC', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#000', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>CSV export</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#86EFAC', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#000', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Financial education library</p>
                </div>
              </div>

              <p style={{ fontFamily: 'Inter', fontSize: '13px', fontWeight: 500, color: '#6B7280', textAlign: 'center', fontStyle: 'italic' }}>
                Use it like a Pro — completely free!
              </p>
            </div>

            {/* Pro Tier */}
            <div className="bg-white" style={{ borderRadius: '20px', padding: '24px', border: '2px solid transparent', backgroundImage: 'linear-gradient(white, white), linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box' }}>
              <div className="flex items-center justify-between mb-4">
                <h3 style={{ fontFamily: 'Inter', fontSize: '24px', fontWeight: 600, color: '#000' }}>Pro</h3>
                <span
                  style={{
                    fontFamily: 'Inter',
                    fontSize: '10px',
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-2">
                  <div style={{ fontFamily: 'Inter', fontSize: '40px', fontWeight: 700, color: '#000' }}>$4.99</div>
                  <div style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#6B7280' }}>/month</div>
                </div>
                <div style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#6B7280' }}>or $34.99/year (save 42%)</div>
              </div>

              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#fff', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Everything in Free</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#fff', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Advanced AI predictions</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#fff', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Priority support (24/7)</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#fff', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Multi-device sync</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#fff', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Custom financial reports</p>
                </div>
                <div className="flex items-start gap-2">
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'linear-gradient(90deg, #5148FF 0%, #FF77E2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                    <span style={{ color: '#fff', fontSize: '12px', fontWeight: 700 }}>✓</span>
                  </div>
                  <p style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, color: '#000' }}>Early access to new features</p>
                </div>
              </div>

              <Button
                onClick={() => {
                  // Track notify me button click
                  if (window.umami) {
                    window.umami.track('notify_me_clicked', { location: 'settings_dialog' });
                  }
                }}
                style={{
                  width: '100%',
              ...
              <p style={{ fontFamily: 'Inter', fontSize: '12px', fontWeight: 400, color: '#6B7280', textAlign: 'center', marginTop: '12px' }}>
                Best price on the market—unlock premium features!
              </p>
            </div>
          </div>
        </DialogContent>
